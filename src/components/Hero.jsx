...
dark:text-white'>
            ...
            <div className="relative w-full">
                <img src={assets.hero_img} alt="hero img" className='w-ful max-w-6xl' />
                <img src={assets.bgImage1} alt="bgcolor" className='absolute -top-40 z-1 -right-40 sm:-top-100 sm:-right-70 dark:hidden' />
            </div>
        </div>
    )
}
