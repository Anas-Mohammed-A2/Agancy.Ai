...
const Hero = () => {
    return (
        <div className='Hero flex flex-col items-center justify-center gap-6 py-20 px-4 sm:px-12
...
dark:text-white'>
            ...
            <div>
                ...
                <p className='text-center text-sm sm:text-lg font-medium text-gray-500 dark:text-white/75 max-w-[80%] sm:max-w-lg pb-3'>Creating meaningful connections and turning big ideas into interactive digital experiences.</p>
